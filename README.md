...
MemoReef imports browser bookmarks into an Obsidian-compatible Markdown vault and turns saved links into an agent-readable source library for future projects.
...
2. Deduplication by URL canonicalization.
